...
| 3.3b.5 | Smoke training: valence_half vs fixed-K=8 on 5000 molecules, 10 epochs, seed=0, target=mu | Both configs complete 10 epochs; no NaN/inf; checkpoints saved; metrics produced | 3.3b.4 | cc:blocked — Slurm 93835 (valence_half d1n41a14g01), 93836 (fixed_K=8 d1n41a21g01). Check: `squeue -u scwc008`. |
